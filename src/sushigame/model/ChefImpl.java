...
//				
//				Sushi [] sushiPlates = new Sushi [plate_history.size()];
//				
//				for (int j = 0; j < plate_history.size(); j ++){
//									
//					sushiPlates [i] = plate_history.get(i).getContents();
//					
//					for (int k = 0; k < sushiPlates.length;k ++ ){
//												
//						IngredientPortion[] ingredientList = sushiPlates[i].getIngredients();
//						
//							for (int l = 0;  l < ingredientList.length; l++ ){
//															}
//								double amount = ingredientList[i].getAmount();
//								
//								_foodSold += amount;
//						}
//				   }
...
//		for(int i = 0; i< plate_history.size(); i++){
//			
//			if (plate_history.get(i).wasSpoiled()){	
//				
//				Sushi [] sushiPlates = new Sushi [plate_history.size()];
//				
//				for (int j = 0; j < plate_history.size(); j ++){
